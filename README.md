...
###### Description
 ...
 This actions can be used to control chef. The available functions enables you to provision a new host with chef and control this process from the release manager.. [Check the Feature support by action pack](source/README.md)
